...
HD_PWD='D:/dario/fulgor/trabajo_final/vivado_projects/ethernet_GMII_v1/ethernet_GMII_v1.runs/bd_d93c_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_d93c_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_d93c_mac_0.tcl
