...
HD_PWD='D:/dario/fulgor/trabajo_final/vivado_projects/ethernet_GMII_v1/ethernet_GMII_v1.runs/eth1_axi_ethernet_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth1_axi_ethernet_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth1_axi_ethernet_0_0.tcl
