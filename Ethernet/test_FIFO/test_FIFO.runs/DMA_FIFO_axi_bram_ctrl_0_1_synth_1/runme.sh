...
HD_PWD='D:/dario/fulgor/trabajo_final/vivado_projects/test_FIFO/test_FIFO.runs/DMA_FIFO_axi_bram_ctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_FIFO_axi_bram_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_FIFO_axi_bram_ctrl_0_1.tcl
