...
HD_PWD='D:/dario/fulgor/trabajo_final/vivado_projects/test_FIFO/test_FIFO.runs/DMA_FIFO_rst_mig_7series_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_FIFO_rst_mig_7series_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_FIFO_rst_mig_7series_0_100M_0.tcl
