...
HD_PWD='/home/becario/ethernet/TPF-Fulgor-2020/Ethernet/test_FIFO/test_FIFO.runs/DMA_FIFO_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_FIFO_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_FIFO_xbar_1.tcl
