...
fpga -file D:/dario/fulgor/trabajo_final/vivado_projects/test_FIFO/workspace/dma_fifo/_ide/bitstream/download.bit
configparams mdm-detect-bscan-mask 2
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-SMT1 210203367268A"} -index 0
rst -system
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent JTAG-SMT1 210203367268A"} -index 0
dow D:/dario/fulgor/trabajo_final/vivado_projects/test_FIFO/workspace/dma_fifo/Debug/dma_fifo.elf
bpadd -addr &main
