...
simulate()
{
  xsim DMA_FIFO -key {Behavioral:sim_1:Functional:DMA_FIFO} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c263.protoinst" -protoinst "protoinst_files/DMA_FIFO.protoinst" -log simulate.log
}
