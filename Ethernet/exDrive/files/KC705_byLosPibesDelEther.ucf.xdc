...
##QUAD SPI FLASH MEMORY CONNECTIONS
## set_property PACKAGE_PIN P24 [get_ports FLASH_D0]
## set_property IOSTANDARD LVCMOS25 [get_ports FLASH_D0]
## set_property PACKAGE_PIN R25 [get_ports FLASH_D1]
## set_property IOSTANDARD LVCMOS25 [get_ports FLASH_D1]
...
## set_property PACKAGE_PIN R21 [get_ports FLASH_D3]
## set_property IOSTANDARD LVCMOS25 [get_ports FLASH_D3]
## set_property PACKAGE_PIN U19 [get_ports FPGA_FCS]    ## QSPI_IC_CS_B THROUGH U64 AND J3
...
##7N700 (NO APARECE EN MANUAL)
## set_property PACKAGE_PIN AC17 [get_ports 7N700]

##9NXXX (NO APARECE EN MANUAL)
...
##SW15 POWER ON/OFF
##SW14 FPGA_PROG
##SW13 (DEFAULT-CONFIG: SW13[5:1] = [01000])
##FPGA Configuration Mode: DIP switch SW13 positions 3, 4, and 5 
## control which configuration mode is used at power-up or when the PROG pushbutton is pressed.
##Linear BPI Flash Memory Upper Addresses: DIP switch SW13 positions 1 and 2 
## control the setting of address bits FLASH_A25 and FLASH_A24. 
## The mode signals FPGA_M2, _M1 and _M0 are connected to FPGA U1 pins AB1, AB2 and AB5 respectively.
## The BPI flash memory U58 address signals FLASH_A24 AND FLASH_A25 are connected to 
## FPGA U1 pins M23 and M22 respectively. 
